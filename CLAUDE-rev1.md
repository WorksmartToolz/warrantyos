...
See Phase 3 Decision 22 (docs/session-handoffs/5e-bridge-phase3-decisions-log-rev1.md)
and the Database Migration Tooling section in docs/architecture-reference-v2-rev1.md
